...
@description('認可対象となるAzure ADに登録されたアプリのIDを指定してください（例: api://d0e6352e-29d3-4f6c-b5d9-e4df26201023）')
param audienceAppId string = 'api://d0e6352e-29d3-4f6c-b5d9-e4df26201023'
...
param tenantId string = '0ed0d7e5-95e0-4cc3-a9bc-8ccfadfe2e5f'
