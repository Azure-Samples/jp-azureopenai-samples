...
$env:AZURE_STORAGE_KEY=(az storage account keys list -g $env:AZURE_COSMOSDB_RESOURCE_GROUP -n $env:AZURE_STORAGE_ACCOUNT | ConvertFrom-Json)[0].value
