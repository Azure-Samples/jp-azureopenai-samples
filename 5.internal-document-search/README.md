...
### 本サンプル以外の実装について
本サンプルは、Microsoftの米国本社を中心に開発と公開している[ChatGPT + Enterprise data with Azure OpenAI and AI Search](https://github.com/Azure-Samples/azure-search-openai-demo)を参考にしたものです。日本の開発者に使いやすいように、日本語のREADME、日本語のサンプルデータ、Azureの日本リージョン活用のデフォルト化、プライベートネットワーク構成含む考慮事項等を追加しています。こちらのサンプルとあわせて、是非[ChatGPT + Enterprise data with Azure OpenAI and AI Search](https://github.com/Azure-Samples/azure-search-openai-demo)の活用もご検討ください。
