...
class WebHook(object):
    ...
    def __init__(self, links=None, properties=None, _self=None, display_name=None, description=None, web_url=None, events=None, created_date_time=None, last_action_date_time=None, status=None, custom_properties=None, _configuration=None):  # noqa: E501
    ...
    def links(self):
        ...
        The links for additional actions or content related to this webhook.  # noqa: E501
    ...
    def properties(self):
        ...
        Additional configuration options when creating a new webhook  and additional metadata provided by the service.  # noqa: E501
